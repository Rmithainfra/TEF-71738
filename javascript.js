var viewer = pannellum.viewer('panorama',{ 
    ...
    "scenes": {
        ...
        "minPitch":-25,
        "maxPitch": 25,
        "yaw":-26,            //  IF NEEDED CHANGE THE YAW VALUE
        "compass":true,
        "northOffset":26 //  IF NEEDED CHANGE THE NORTHOFFSET VALUE
      },
      ...
      "image-3":{
        "type": "equirectangular",
        "panorama": "25m.jpg",  // CHANGE THE IMAGE NAME
        "hfov":200,
        "haov":360,
        "vaov":87,
        "minPitch":-25,
...
function updateDegreeScale() {
    ...
    var initialYaw = {
      "image-360": -10, // GIVE THE YAW VALUE AS IT IS
      "image-1": -26,  // GIVE THE YAW VALUE
      "image-2": -26,  // GIVE THE YAW VALUE
      "image-3": -26,// GIVE THE YAW VALUE
    //   "image-4": 0   
    //   "image-5": 0   
    };
